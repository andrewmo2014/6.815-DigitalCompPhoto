...
def main():
    ...
    # intermediate Exprs
    gx[x,y,c]= (-clamped[x-1,y-1,c]+clamped[x+1,y-1,c]
                -2*clamped[x-1,y,c]+2*clamped[x+1,y,c]
                -clamped[x-1,y+1,c]+clamped[x+1,y+1,c])/4.0
    # Similarly define the vertical gradient. 
    gy[x,y,c]= (-clamped[x-1,y-1,c]+clamped[x-1,y+1,c]
    ...
    imageIO.imwrite(outputNP, 'tut4outSobel.png', gamma=1.0)
